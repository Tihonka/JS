...
let productInfo = document.querySelector('.products');
let productMarkup = "";
...
function showCategory(category) {
    ...
    productCategory.forEach(function(product){
        productMarkup = productMarkup + getProductMarkup(product);
    })
     productInfo.insertAdjacentHTML('afterbegin', productMarkup);
}
